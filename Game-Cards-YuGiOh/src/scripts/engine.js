...
if(fieldSide === state.playerSides.player1){
    ...
    drawSelectCard(idCard);
       ...
       cardImage.classList.add("cardComputer"); 
}
...
let imgElementns = cards.querySelectorAll("img");
imgElementns.forEach((img) => img.remove());


cards = state.playerSides.player1Box;
imgElementns = cards.querySelectorAll("img");
imgElementns.forEach((img) => img.remove());
}
